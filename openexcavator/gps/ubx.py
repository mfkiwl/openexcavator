...
class UBX(threading.Thread):
    ...
    def __init__(self, gps_queue: deque, serial_port="/dev/ttyACM0", baud_rate=115200, ntrip_queue: Queue=None):
        """
    ...
    def run(self):
        ...
        while self.running:
            ...
            if parsed_data.msgID == "GGA":  # GPS Fix Data
               ...
               data["ts"] = datetime.datetime.combine(datetime.date(parsed_data.year, parsed_data.month, parsed_data.day), parsed_data.time)
